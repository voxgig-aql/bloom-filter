...
cd /tmp/aql-source
git checkout 234247709f7d971575da41a9b833f6b3e7fd8052   # the commit CI pins (.github/workflows/test.yml AQL_REF)
cd cmd/go
...
This module is verified against aql commit `2342477`; the CI workflow
